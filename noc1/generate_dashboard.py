...
def intelligence_panel_html(data, summary):
    ...
    return f"""<div id="intel-overlay" class="intel-overlay" onclick="intelOverlayClick(event)"></div><aside id="intel-panel" class="intel-panel"><div class="intel-panel-hdr"><div class="intel-panel-title"><svg class="intel-title-svg" viewBox="0 0 24 24" aria-hidden="true"><path d="M4 19V5"/><path d="M4 19h16"/><path d="M8 16v-5"/><path d="M12 16V8"/><path d="M16 16v-7"/><path d="M20 16v-3"/></svg><span>NOC INTELLIGENCE</span></div><button onclick="toggleIntel(false)">&times;</button></div><div class="intel-panel-scroll">
