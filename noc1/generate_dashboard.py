...
<body>
  <div class="topbar">
    ...
    <div class="top-right">
      ...
      <button id="intel-btn" class="theme-btn" onclick="toggleIntel(true)" title="NOC Intelligence" aria-label="NOC Intelligence"><svg class="nav-svg" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg></button>
...
(function() {{
  ...
  document.addEventListener('click', function(e) {{ var m=document.getElementById('gear-menu'); if(!m)return; var path=e.composedPath?e.composedPath():[]; if(m.contains(e.target)||path.indexOf(m)!==-1)return; m.classList.remove('open'); }});
